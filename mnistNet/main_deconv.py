...
path_train	= './data/'
path_model  = './mnistNet_deconv.hdf5'
...
def inference():
	...
	if SingleTest:
		path_test 	= './data/testSample/img_106.jpg'
...
def inference_deconv():
	...
	path_test 	= './data/trainingSample/0/img_5.jpg'
	# path_test = './data/trainingSampleSeg/0/img_4.png'
